...
eg for 5e, you should multiply for 4, for 6a1 multiply by 2 etc.
Note that I have separated the degenerate #e into #e1 and #e2 (#=1,..,5) however the form factors after rotational averaging for #e1 and #e2 are the same (this is analogous to eg 2px, 2py, 2pz in neon having the same form factor after rotational averaging). Therefore you can either keep #e1 and #e2 separately, each with an occupation of 2, or set #e1=#e and use an occupation of 4.
