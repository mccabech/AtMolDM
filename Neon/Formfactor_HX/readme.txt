...
eg for 5p, you should multiply for 6, for 5s, multiply by 2 etc.
...
Outgoing electron wave functions were obtained by solving the Schroedinger equation with the HX-potential described in the paper.

The 2p rates have been obtained by summing over the m quantum number, which is equivalent to rotational averaging.